...
try:
    ...
    caso_1_reten_IVA_GEN(driver, EMISION_CONSTANCIAS_EMISION_DEL, EMISION_CONSTANCIAS_EMISION_AL, EMISION_CONSTANCIAS_RETENCIONES_QUE_DECLARA_IVA, EMISION_CONSTANCIAS_REGIMEN_GEN, EMISION_CONSTANCIAS_TIPO_DOCUMENTO, EMISION_CONSTANCIAS_NIT_RETENIDO, EMISION_CONSTANCIAS_NO_AUTORIZACION_FEL, EMISION_CONSTANCIAS_SERIE_DE_FACTURA, EMISION_CONSTANCIAS_NO_DE_FACTURA, EMISION_CONSTANCIAS_DIRECTORIO_DESCARGAS, EMISION_CONSTANCIAS_DIRECTORIO_FACTURAS_IVA, EMISION_CONSTANCIAS_NOMBRE_PROVEEDOR, CAMI_NOMBRE_EMPRESA)
...
try:
    ...
    caso_2_reten_IVA_e_ISR(driver, EMISION_CONSTANCIAS_EMISION_DEL,EMISION_CONSTANCIAS_EMISION_AL, EMISION_CONSTANCIAS_RETENCIONES_QUE_DECLARA_IVA, EMISION_CONSTANCIAS_REGIMEN_GEN,EMISION_CONSTANCIAS_TIPO_DOCUMENTO, EMISION_CONSTANCIAS_NIT_RETENIDO, EMISION_CONSTANCIAS_NO_AUTORIZACION_FEL,EMISION_CONSTANCIAS_SERIE_DE_FACTURA, EMISION_CONSTANCIAS_NO_DE_FACTURA, EMISION_CONSTANCIAS_DIRECTORIO_DESCARGAS, EMISION_CONSTANCIAS_DIRECTORIO_FACTURAS_IVA, EMISION_CONSTANCIAS_NOMBRE_PROVEEDOR, CATEGORIA_DE_RENTAS_NIT_RETENIDO, CATEGORIA_DE_RENTAS_PERIODO_DEL, CATEGORIA_DE_RENTAS_PERIODO_AL, CATEGORIA_DE_RENTAS_ESTADO_DE_ASIGNACION, CATEGORIA_DE_RENTAS_NO_DE_FACTURA, CATEGORIA_DE_RENTAS_OPCION_CATEGORIA_DE_RENTA, CATEGORIA_DE_RENTAS_OPCION_REGIMEN, EMISION_CONSTANCIAS_RETENCIONES_QUE_DECLARA_ISR, EMISION_CONSTANCIAS_DIRECTORIO_FACTURAS_ISR)
...
try:
    ...
    caso_3_reten_IVA_PEQ(driver, EMISION_CONSTANCIAS_EMISION_DEL, EMISION_CONSTANCIAS_EMISION_AL, EMISION_CONSTANCIAS_RETENCIONES_QUE_DECLARA_IVA, EMISION_CONSTANCIAS_REGIMEN_PEQ, EMISION_CONSTANCIAS_TIPO_DOCUMENTO, EMISION_CONSTANCIAS_NIT_RETENIDO, EMISION_CONSTANCIAS_NO_AUTORIZACION_FEL, EMISION_CONSTANCIAS_SERIE_DE_FACTURA, EMISION_CONSTANCIAS_NO_DE_FACTURA,  EMISION_CONSTANCIAS_DIRECTORIO_DESCARGAS, EMISION_CONSTANCIAS_DIRECTORIO_FACTURAS_IVA, EMISION_CONSTANCIAS_NOMBRE_PROVEEDOR)
